...
| 12  | **Ne pas relayer les rafales**                          | plafond de 20 calculs/minute sur `/routes/plan` : l'endpoint le plus coûteux est aussi une arme d'amplification contre nos fournisseurs de données                            | UF-604         |

...
| ------------------------------------------------------------ | -------------------------------------------------------- | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Navigations (`/`, `/impact`, `/profil`…)                     | **network-first**, repli sur le shell `/`                | `urbanflow-shell-v2`      | Le contenu est authentifié et daté : le réseau doit gagner quand il est là. Le repli évite l'écran blanc.                                       |
...
| `/manifest.json`, `/icons/*`                                 | **cache-first** (précachés)                              | `urbanflow-shell-v2`      | Nécessaires à l'app installée ; petits, stables, et attendus par l'OS au lancement.                                                             |
